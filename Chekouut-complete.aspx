<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Chekouut-complete.aspx.cs" Inherits="Projet_De_Fin_Detude.WebForm19" %>
					...
					<div class="container">
						<div class="card py-3 mt-sm-3">
							<div class="card-body text-center">
								...
								<%--<a class="btn btn-light rounded-0 mt-3 me-3" href="index.html">Go back shopping</a>--%>
								<asp:HyperLink ID="HyperLink1" CssClass="btn btn-light rounded-0 mt-3 me-3" runat="server" NavigateUrl="~/AllProduct.aspx">Go back shopping</asp:HyperLink>
							</div>
						</div>
					</div>
				</section>
