<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Dashbord.aspx.cs" Inherits="Projet_De_Fin_Detude.WebForm12" %>
										...
										<div class="card shadow-none mb-3 mb-lg-0">
											<div class="card-body">
												<div class="list-group list-group-flush">
													<a href="Dashbord.aspx" class="list-group-item active d-flex justify-content-between align-items-center">Dashboard <i class='bx bx-tachometer fs-5'></i></a>
									...
									<div class="col-lg-8">
										<div class="card shadow-none mb-0">
											<div class="card-body">
												...
												<p>In this Dashboard there is information about your site, and you can add and delete any information that finds on this site</p>
											</div>
										</div>
									</div>
								</div>
